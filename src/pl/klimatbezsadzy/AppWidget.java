...
public class AppWidget extends AppWidgetProvider {
  ...
  private RemoteViews buildUpdate(Context ctxt, int[] appWidgetIds) {
   ...
   updateViews.setOnClickPendingIntent(R.id.station1, pi);
   updateViews.setOnClickPendingIntent(R.id.station2, pi);
   updateViews.setOnClickPendingIntent(R.id.station3, pi);
