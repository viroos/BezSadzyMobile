...
public class AllertService extends Service {
		...
		CharSequence tickerText = "The control service is getting closer.";
		...
		private void notificationLoop() {
			...
			timer.scheduleAtFixedRate(new TimerTask() {
				...
				public void run() {
					...
					CharSequence contentTitle = "Ticket Aware";
					CharSequence contentText = "The control service is getting closer.";
